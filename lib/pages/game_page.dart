...
class GamePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var screenWidth = MediaQuery.of(context).size.height * 9 / 18;
    return Scaffold(
        body: SafeArea(
            child: Center(
              child: Container(
                        ...
                        children: <Widget>[
                          ...
                          FutureBuilder<GridData>(
                            ...
                            builder: (BuildContext context,
                                AsyncSnapshot<GridData> snapshot) {
                                      ...
                                      itemBuilder: (context, position) {
                                        if (player1) {
                                          if (player1Pos ==
                                            ...
                                            player1GotoPos = snapshot.data
                                                .gridItems[position].goToPosition;
                                        } else if (player2Pos ==
                                            snapshot
                                                .data.gridItems[position].position)
  ...
  Future<GridData> _readJson() async {
    var jsonString = await rootBundle.loadString('grid_data.json');
